...
-	Condicionales (if bloque/oneline & switch clásico/moderno)
-	Iteradores (for, while, do/while, recursividad)
-	Declaración de variables, atributos, métodos y constructores
...
##### 4.	Motor de testing
- Unidad básica (Test)
- Ciclo de vida del test (BeforeAll, BeforeEach, AfterEach, AfterAll)
- Validaciones de exito (metodos de clase Assertions)
- Nombres descriptivos 
##### 5.	Mockito
- Diferencia teórica entre dummy/stub y mock
- Inyección de dependencias (Mock & InjectMocks)
- Inyección de comportamiento
- Triggers de verificación
##### 6.	¿Cómo funciona Spring y Spring Boot? ¿Cómo probarlo?
- Simulación de llamado al API desde afuera
- Simulación de llamado a base de datos con H2
- Inyección de Mocks
